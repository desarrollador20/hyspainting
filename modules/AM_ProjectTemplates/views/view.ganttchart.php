...
class AM_ProjectTemplatesViewGanttChart extends ViewDetail
{
    public function display()
    {
                ...
                <form id="popup_form">
                    <fieldset>
						<table width="100%">
							...
							<input type="hidden" style="display: none;" name="task_id" id="task_id" value="">
							...
							<?php
                            echo '<select style="display: none;" id="Predecessor" name="Predecessor" class="text ui-widget-content ui-corner-all" />';
        if (!isset($tasks)) {
            $tasks = [];
        }
        foreach ($tasks as $task) {
            echo '<option style="display: none;" rel="'.$task->id.'" value="'.$task->order_number.'">'.$task->name.'</opion>';
        }
        echo '</select>'; ?>
							
							<?php
                            echo '<select style="display: none;" id="relation_type" name="relation_type" class="text ui-widget-content ui-corner-all">
							...
							<input type="hidden" name="Duration" id="Duration" class="text ui-widget-content ui-corner-all" />
							<select style="display: none;"  id="Duration_unit" name="Duration_unit" class="text ui-widget-content ui-corner-all" />
								<option value="Days">Days</option>
							</select>

						
							<?php
                            echo '<select style="display: none;" id="Resources" name="Resources" class="text ui-widget-content ui-corner-all" />';
        ...
        echo '</select>'; ?>
							...
							<input type="hidden" name="Complete" id="Complete" value="0" class="text ui-widget-content ui-corner-all" />
