        ...
        if (!empty($templates)) {
            ...
            foreach ($templates as $templateid => $template) {
                ...
                echo '<tr height="20" class="' . $iOddEvenCls . '" >
                    ...
                    '\', \'index.php?templateID=' . $templateid . '&entryPoint=formLetterProyectos\',\'' . $app_strings['LBL_LISTVIEW_NO_SELECTED'] . '\');"><img src="themes/default/images/txt_image_inline.gif" width="16" height="16" /></a></td>
                                            <td scope="row" align="left"><b><a href="#" onclick="$(\'#popupDiv_ara\').modal(\'hide\');sListView.send_form(true, \'' . $module .
                    '\', \'index.php?templateID=' . $templateid . '&entryPoint=formLetterProyectos\',\'' . $app_strings['LBL_LISTVIEW_NO_SELECTED'] . '\');">' . $template . '</a></b></td></tr>';
                $iOddEven++;
            }
            echo '</tbody></table>
                        </div>
            ...
            <div id="popupDiv_ara" class="modal fade" style="display: none;">
               <div class="modal-dialog">
                  <div class="modal-content">
                     ...
                     <div class="modal-body">
                        <div style="padding: 5px 5px; overflow: auto; height: auto;">
                           <form id="popupForm" action="index.php?entryPoint=formLetterProyectos" method="post">
                              <table width="100%" class="list view table-responsive" cellspacing="0" cellpadding="0" border="0">
                                 <tbody>';
            $iOddEven = 1;
            foreach ($templates as $templateid => $template) {
